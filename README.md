...
Welcome to my **Computer Science Portfolio** — a curated collection of my coursework, projects, and hands-on experiences throughout my degree program at **Southern New Hampshire University (SNHU)**.

This portfolio showcases core software engineering skills including testing, security, data structures, systems analysis, and more.
...
This portfolio demonstrates my progression and hands-on application of key software engineering principles. Each course-focused repo contains project deliverables that reflect real-world software development lifecycle practices.

---

> 🔗 Connect with me: [LinkedIn](https://linkedin.com/in/dan-lowery) · [Website](https://danlowery.dev)
